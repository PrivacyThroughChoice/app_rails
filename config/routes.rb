WebnarkRails::Application.routes.draw do
  ...
  get '/pages/contact', to: 'high_voltage/pages#show', id: 'contact'
  get '/pages/security', to: 'high_voltage/pages#show', id: 'security'
  get '/pages/thankyou', to: 'high_voltage/pages#show', id: 'thankyou'
